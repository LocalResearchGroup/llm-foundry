...
TRAINING_GPU = "A100-80GB" # "a10g" "h100" # "l4"
BATCH_SIZE = 16 # 20 for h100 4 for l4
MAX_DURATION="5000ba"
EVAL_INTERVAL="0"
...
yaml_path = "train/yamls/finetune/smollm2-135m_dora.yaml"

app = App("weight-changes-dora")
...
def train_model(run_ts: str, yaml_path: str = ""):
    import os, subprocess, shutil
    from pathlib import Path

    #os.environ['LRG_TAGS'] = 'LRG_TAGS_PR-39,LRG_TAGS_test-run,LRG_TAGS_no data prep'
    ...
    train_cmd = [
        ...
        f"loggers.aim.experiment_name=vishal_llm-foundry_smollm2-135m_dora_5000ba",
        f"loggers.aim.repo={run_folder}/.aim",
        f"variables.data_local={DATASETS_VOLUME_MOUNT_PATH}/meta-math/MetaMathQA",
