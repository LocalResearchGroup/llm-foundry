...
# class CustomLlamaModel(HuggingFaceModel):
#     """Custom Llama model that properly integrates with Composer and PEFT."""
...
#         # Initialize HuggingFaceModel with proper configuration
#         super().__init__(
#             model=model,
#             tokenizer=tokenizer,
#             use_logits=False,  # Raw outputs
#             shift_labels=True,  # For causal LM
#             peft_config=peft_config,  # PEFT config
#             should_save_peft_only=True,  # Adapter weights only
#             **kwargs
#         )
...
#         pretrained_path = config.get("pretrained_model_name_or_path")
#         if not pretrained_path:
#             raise ValueError(
#                 "pretrained_model_name_or_path must be specified in config"
#             )
            
#         return cls.from_pretrained(
#             pretrained_model_name_or_path=pretrained_path,
#             use_flash_attention_2=config.get("use_flash_attn", True),
...
#     def _copy_weights_from_hf_llama(self, hf_model: PreTrainedModel) -> None:
#         """Copy weights from HuggingFace model to our custom implementation"""
#         # This method needs to be implemented based on your specific model structure
#         # Here's a simplified version - you'll need to adapt this to your architecture
